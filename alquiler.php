...
<body>
	<nav class="navbar navbar-default">
     ...
     <article class="container"> 
	     <div class="row">      
	     	    <h2 class="text-center"><strong>Alquiler</strong></h2>
     ...
     <article class="container">
		    ...
		    <?php  
				    ...
				    $q = "select id,tipo,zona,direccion,barrio,descripcion,disponible,servicio,valor,admon,id_propietario from inmuebles where servicio = 'Alquiler'"; 
